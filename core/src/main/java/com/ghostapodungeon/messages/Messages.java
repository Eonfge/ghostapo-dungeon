...
package com.ghostapodungeon.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.ghostapodungeon.messages.actors.actors",
			"com.ghostapodungeon.messages.items.items",
			"com.ghostapodungeon.messages.journal.journal",
			"com.ghostapodungeon.messages.levels.levels",
			"com.ghostapodungeon.messages.plants.plants",
			"com.ghostapodungeon.messages.scenes.scenes",
			"com.ghostapodungeon.messages.ui.ui",
			"com.ghostapodungeon.messages.windows.windows",
			"com.ghostapodungeon.messages.misc.misc"
	};

	static{
		setup(ghostapodungeon.language());
	}
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.ghostapodungeon.", "");
			key += "." + k;
		} else
			key = k;
