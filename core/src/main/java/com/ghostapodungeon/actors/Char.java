...
package com.ghostapodungeon.actors;
...
import com.ghostapodungeon.actors.buffs.Preparation;
import com.ghostapodungeon.actors.buffs.Slow;
import com.ghostapodungeon.actors.buffs.Speed;
...
public abstract class Char extends Actor {
	...
	public void move( int step ) {
		...
		if (Dungeon.level.adjacent( step, pos ) && buff( Vertigo.class ) != null) {
			...
			if (!(Dungeon.level.passable[newPos] || Dungeon.level.avoid[newPos]) || findChar( newPos ) != null)
				return;
			else {
