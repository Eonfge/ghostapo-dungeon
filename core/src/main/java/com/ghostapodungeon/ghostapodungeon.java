...
import com.ghostapodungeon.scenes.WelcomeScene;
import com.ghostapodungeon.messages.Languages;
...
public class ghostapodungeon extends Game {
	...
	public ghostapodungeon() {
		super( WelcomeScene.class );
		
		//v0.6.0
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.levels.rooms.special.MassGraveRoom.Bones.class,
				"com.ghostapodungeon.levels.painters.MassGravePainter$Bones" );
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.levels.rooms.standard.RitualSiteRoom.RitualMarker.class,
				"com.ghostapodungeon.levels.painters.RitualSitePainter$RitualMarker" );
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.levels.rooms.special.WeakFloorRoom.HiddenWell.class,
				"com.ghostapodungeon.levels.painters.WeakFloorPainter$HiddenWell" );
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.levels.rooms.Room.class,
				"com.ghostapodungeon.levels.Room" );
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.items.weapon.melee.Shortsword.class,
				"com.ghostapodungeon.items.weapon.melee.NewShortsword" );
		
		//v0.6.0a
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.items.food.SmallRation.class,
				"com.ghostapodungeon.items.food.OverpricedRation" );
		
		//v0.6.2
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.levels.rooms.secret.RatKingRoom.class,
				"com.ghostapodungeon.levels.rooms.special.RatKingRoom" );
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.levels.rooms.standard.PlantsRoom.class,
				"com.ghostapodungeon.levels.rooms.standard.GardenRoom" );
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.levels.rooms.special.GardenRoom.class,
				"com.ghostapodungeon.levels.rooms.special.FoliageRoom" );
		
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.levels.traps.WornDartTrap.class,
				"com.ghostapodungeon.levels.traps.WornTrap" );
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.levels.traps.PoisonDartTrap.class,
				"com.ghostapodungeon.levels.traps.PoisonTrap" );
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.levels.traps.ShockingTrap.class,
				"com.ghostapodungeon.levels.traps.ParalyticTrap" );
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.levels.traps.ShockingTrap.class,
				"com.ghostapodungeon.levels.traps.LightningTrap" );
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.levels.traps.GrippingTrap.class,
				"com.ghostapodungeon.levels.traps.SpearTrap" );
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.levels.traps.BurningTrap.class,
				"com.ghostapodungeon.levels.traps.FireTrap" );
		
		com.watabou.utils.Bundle.addAlias(
				com.ghostapodungeon.actors.buffs.BlobImmunity.class,
				"com.ghostapodungeon.actors.buffs.GasesImmunity" );
		
		com.watabou.utils.Bundle.exceptionReporter =
				new com.watabou.utils.Bundle.BundleExceptionCallback() {
					@Override
					public void call(Throwable t) {
						ghostapodungeon.reportException(t);
					}
				};
	...
	public static void landscape( boolean value ) {
		...
		((ghostapodungeon)instance).updateDisplaySize();
	}
	...
	public static void immerse( boolean value ) {
		...
		instance.runOnUiThread( new Runnable() {
			...
			public void run() {
				...
				((ghostapodungeon)instance).view.getHolder().setSizeFromLayout();
			}
		} );
	}
