...
package com.ghostapodungeon.items.weapon;
...
import com.ghostapodungeon.actors.hero.HeroClass;
...
import com.ghostapodungeon.items.weapon.curses.Displacing;
import com.ghostapodungeon.items.weapon.curses.Exhausting;
import com.ghostapodungeon.items.weapon.curses.Sacrificial;
import com.ghostapodungeon.items.weapon.curses.Wayward;
import com.ghostapodungeon.items.weapon.enchantments.Blazing;
import com.ghostapodungeon.items.weapon.enchantments.Chilling;
import com.ghostapodungeon.items.weapon.enchantments.Dazzling;
import com.ghostapodungeon.items.weapon.enchantments.Grim;
import com.ghostapodungeon.items.weapon.enchantments.Projecting;
import com.ghostapodungeon.items.weapon.enchantments.Venomous;
import com.ghostapodungeon.items.weapon.missiles.MissileWeapon;
import com.ghostapodungeon.items.Item;
import com.ghostapodungeon.items.weapon.curses.Annoying;
import com.ghostapodungeon.items.weapon.curses.Fragile;
import com.ghostapodungeon.items.weapon.enchantments.Eldritch;
import com.ghostapodungeon.items.weapon.enchantments.Lucky;
import com.ghostapodungeon.items.weapon.enchantments.Shocking;
import com.ghostapodungeon.items.weapon.enchantments.Stunning;
import com.ghostapodungeon.items.weapon.enchantments.Unstable;
import com.ghostapodungeon.items.weapon.enchantments.Vampiric;
import com.ghostapodungeon.items.weapon.enchantments.Vorpal;
import com.ghostapodungeon.items.weapon.melee.MeleeWeapon;
