...
import com.ghostapodungeon.ui.ChangesButton;
import com.ghostapodungeon.ui.ExitButton;
import com.ghostapodungeon.ui.LanguageButton;
import com.ghostapodungeon.ui.PrefsButton;
	...
	public void create() {
		...
		DashboardItem btnBadges = new DashboardItem( Messages.get(this, "badges"), 3 ) {
			...
			protected void onClick() {
				ghostapodungeon.switchNoFade( BadgesScene.class );
			}
		};
		add(btnBadges);
		...
		DashboardItem btnAbout = new DashboardItem( Messages.get(this, "about"), 1 ) {
			@Override
			protected void onClick() {
				ghostapodungeon.switchNoFade( AboutScene.class );
			}
		};
		add( btnAbout );
		...
		DashboardItem btnRankings = new DashboardItem( Messages.get(this, "rankings"), 2 ) {
			@Override
			protected void onClick() {
				ghostapodungeon.switchNoFade( RankingsScene.class );
			}
		};
		add( btnRankings );
