...
public class AboutScene extends PixelScene {
	...
	public void create() {
		...
		final float colWidth = Camera.main.width / (ghostapodungeon.landscape() ? 2 : 1);
		final float colTop = (Camera.main.height / 2) - (ghostapodungeon.landscape() ? 30 : 90);
		final float wataOffset = ghostapodungeon.landscape() ? colWidth : 0;
		...
		wata.y = ghostapodungeon.landscape() ?
						colTop:
