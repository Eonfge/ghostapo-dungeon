...
import com.ghostapodungeon.Chrome;
import com.ghostapodungeon.ghostapodungeon;
import com.ghostapodungeon.effects.BadgeBanner;
import com.ghostapodungeon.items.DewVial;
...
import com.ghostapodungeon.items.stones.StoneOfEnchantment;
...
import com.ghostapodungeon.ui.ExitButton;
import com.ghostapodungeon.ui.Icons;
import com.ghostapodungeon.ui.RenderedTextMultiline;
import com.ghostapodungeon.ui.ScrollPane;
import com.ghostapodungeon.windows.WndTitledMessage;
import com.ghostapodungeon.items.Ankh;
import com.ghostapodungeon.items.artifacts.CloakOfShadows;
import com.ghostapodungeon.items.food.Blandfruit;
...
import com.ghostapodungeon.ui.Archs;
...
public class ChangesScene extends PixelScene {
	...
	protected void onBackPressed() {
		ghostapodungeon.switchNoFade(TitleScene.class);
	}
	...
	private static class ChangeInfo extends Component {
		...
		public ChangeInfo( String title, boolean majorTitle, String text){
			...
			if (majorTitle){
				this.title = renderText( title, 9 );
				line = new ColorBlock( 1, 1, 0xFF222222);
				add(line);
			} else {
				this.title = renderText( title, 6 );
			...
			if (text != null && !text.equals("")){
				this.text = renderMultiline(text, 6);
				add(this.text);
			}
	...
	private static class ChangeButton extends Component {
		...
		protected void onClick() {
			ghostapodungeon.scene().add(new ChangesWindow(new Image(icon), title, message));
		}
